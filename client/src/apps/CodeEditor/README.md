...
- **`src/components/ai/`** - AI-related UI components (Shared)
...
- **`src/apps/CodeEditor/components/editor/`** - Code editing components
...
- **`apps/code_editor/agent_runner.py`** - Main agent orchestration
...
- **`apps/code_editor/agent/agent.py`** - Core Agent class
...
- **`apps/code_editor/indexing_builder.py`** - Server-side indexing (mandatory)
