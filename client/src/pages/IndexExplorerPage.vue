              ...
              <div v-else class="column q-gutter-sm">
                ...
                <div class="row items-center justify-between">
                  ...
                  <span class="text-weight-bold">{{
                    indexStats.symbolCount.toLocaleString()
                  }}</span>
                </div>
                <div class="row items-center justify-between">
                ...
                <div class="row items-center justify-between">
                  ...
                  <span class="text-weight-bold">{{
                    indexStats.vectorCount.toLocaleString()
                  }}</span>
                </div>
            ...
            <q-card-section>
              ...
              <template v-else-if="indexingProgress">
                <div class="column q-gutter-sm">
                  ...
                  <div
                    v-if="indexingProgress?.currentFile"
                  ...
                  <div
                    v-if="indexingProgress?.pausedReason"
                    class="text-caption text-warning q-mt-xs"
                  >
                    Paused:
                    {{
                      indexingProgress.pausedReason === 'memory'
          ...
          <q-card class="col-12">
            <q-card-section>
              ...
              <div v-if="searchResults.length > 0" class="q-mt-md">
                <div class="text-subtitle2 q-mb-sm">Found {{ searchResults.length }} result(s)</div>
                <q-list separator>
                  <q-item
...
const embeddingModelOptions: Array<{ label: string; value: EmbeddingModelId }> = [
  {
    label: 'MiniLM (384d) — sentence-transformers/all-MiniLM-L6-v2',
