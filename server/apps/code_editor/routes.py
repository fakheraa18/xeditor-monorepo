...
# Import from local app modules
from apps.code_editor.llm import handle_embedding_request, handle_embedding_batch_request
from apps.code_editor.providers import get_provider_for_request, LLMRequest
...
from apps.code_editor.prompts.manager import (
    handle_list_prompts,
    handle_get_prompt,
    handle_save_prompt,
...
from apps.code_editor.tools.executor import (
    handle_execute_tool, 
    handle_confirm_command, 
    ensure_ripgrep_available,
    add_file_change_listener as add_tool_file_change_listener
)
...
from apps.code_editor.models.provider_presets import handle_list_provider_presets
from apps.code_editor.models.families import (
...
from apps.code_editor.stream_buffer import get_stream_buffer, init_stream_buffer, shutdown_stream_buffer
...
async def init_app():
    """Initialize stream buffer and tools on startup."""
