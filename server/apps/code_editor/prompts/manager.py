...
from apps.code_editor.prompts.template_processor import process_template
...
async def handle_resolve_prompt(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prompt_context = None
    if context:
        from apps.code_editor.prompts.context_builder import PromptContext, TokenStats, ContextUsage
