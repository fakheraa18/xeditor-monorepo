"""Agent mode prompt for GLM models"""
...
<tool_call>write_file<arg_key>file_path</arg_key><arg_value>src/App.vue</arg_value><arg_key>contents</arg_key><arg_value>export default { name: 'App' }</arg_value></tool_call>
